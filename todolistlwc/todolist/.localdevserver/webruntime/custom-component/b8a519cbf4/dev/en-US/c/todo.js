    ...
    **/
    ...
    function tmpl$8($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 7
      }, [api_text("Task 2"), api_custom_element("lightning-button-icon", _lightningButtonIcon, {
        classMap: {
          "slds-m-left_xx-small": true
        },
        props: {
        ...
        key: 9
      }, [api_text("Task 3"), api_custom_element("lightning-button-icon", _lightningButtonIcon, {
        classMap: {
          "slds-m-left_xx-small": true
        },
        props: {
