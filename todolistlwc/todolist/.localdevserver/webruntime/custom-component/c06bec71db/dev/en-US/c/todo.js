    ...
    * */
    ...
    function tmpl$p($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 9,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.updateTask))
        }
      }, [])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "flexibility": "auto",
        ...
        key: 11,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.addTask))
        }
      }, [])])])])])];
    }
    ...
    class Todo extends lwc.LightningElement {
      ...
      addTask() {
        ...
        console.log(allTask); // this.allTask.push({ id:this.allTask.length+1,
        //   name:this.newTask});
