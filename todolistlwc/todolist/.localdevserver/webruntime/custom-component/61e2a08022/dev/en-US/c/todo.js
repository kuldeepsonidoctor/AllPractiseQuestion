Webruntime.define('lwc/todo', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$p($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 6
      }, api_iterator($cmp.allTask, function (data) {
        return api_element("li", {
          classMap: {
            "slds-item": true
          },
          key: api_key(5, data.id)
        }, [api_custom_element("lightning-layout", _lightningLayout, {
          props: {
          ...
          key: 1
        }, [api_dynamic(data.name)]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
          props: {
            "padding": "horizontal-small"
          },
          key: 3
        ...
        key: 9,
        on: {
          "change": _m1 || ($ctx._m1 = api_bind($cmp.updateTask))
        }
      }, [])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "flexibility": "auto",
        ...
        key: 11,
        on: {
          "click": _m2 || ($ctx._m2 = api_bind($cmp.addTask))
        }
      }, [])])])])])];
    }
    ...
    tmpl$p.stylesheetTokens = {
      hostAttribute: "lwc-todo_todo-host",
      shadowAttribute: "lwc-todo_todo"
    };

    class Todo extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.newTask = '';
        this.allTask = [];
      ...
      deletetask(e) {
        ...
        console.log(id); //for understanding the parse object use the json.stringfy(object)

        alltask = all.splice(all.findIndex(e => e.id === id), 1);
        console.log(this.allTask);
      }

    }

    lwc.registerDecorators(Todo, {
      track: {
        newTask: 1
      },
      fields: ["allTask"]
    ...
    var todo = lwc.registerComponent(Todo, {
      tmpl: _tmpl$o
    });
